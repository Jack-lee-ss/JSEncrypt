...
var key=function(t, e, n) {
    ...
    i.prototype.fromString = function(t, e) {
        ...
        for (var o = t.length, r = !1, a = 0; --o >= 0;) {
            ...
            this[this.t++] = s >> this.DB - a) : this[this.t - 1] |= s << a, (a += n) >= this.DB && (a -= this.DB))
        }
        ...
        if (!(o.t <= 0)) {
            ...
            if (0 != p) {
                ...
                for (; --v >= 0;) {
                    ...
                    if ((n[M] += s.am(0, b, n, v, 0, f)) < b) for (s.dlShiftTo(v, w),
                    n.subTo(w, n); n[M] < --b;)
                    n.subTo(w, n)
                }
    ...
    i.prototype.toString = function(t) {
        ...
        if (a-- > 0) for (s < this.DB && (n = this[a] >> s) > 0 && (i = !0,
        r = l(n)); a >= 0;)
