...
function getpwd(e) {
    ...
    return g.RSAUtils.encryptedString(n, encodeURIComponent(e)).replace(/\s/g, "-")

}
// 注意标点符号，源代码中符号格式 注意不变。
//  "undefined" == typeof g.RSAUtils && (f = g.RSAUtils = {}); 将Q.crypto.rsa.RSAUtils 改为 g.RSAUtils