...
sjcl.json = {
    ...
    encode: function(a) {
        var b, c = "{",
            d = "";
        for (b in a)
        if (a.hasOwnProperty(b)) switch (b.match(/^[a-z0-9]+$/i) || q(new sjcl.exception.invalid("json encode: invalid property name")),
        c += d + '"' + b + '":',
        d = ",",
        typeof a[b]) {
            case "number":
...
function encrypt(e, t, n) {
    var e = sjcl.codec.utf8String.toBits(e),
        ...
        // n = localStorage.getItem("iv");
        n = sjcl.codec.utf8String.toBits(n);
    return sjcl.codec.base64.fromBits(sjcl.mode.ccm.encrypt(a, t, n))

}

function getpwd_u(pwd) {

    return encrypt("japPzkx6o6q24mV3", md5(pwd, undefined, undefined), "A3C960ADB11F");
}

function getpwd_n() {
    var t, n, a = "";
    for (var i = 0; i < 2; i++) {
        t = Math.random() * Math.pow(2, 53);
        n = sjcl.hash.sha256.hash(t.toString() + (new Date).valueOf());
        a += sjcl.codec.base64.fromBits(n)
    }
    return a.substr(0, undefined || 64)

}

function getpwd_g() {

    return "VPqaqxBK6WYBYiim9KJoKmZ5JVfHTZ+3VTeMquW/xN4=7u9/QbhrEpcPHoeZJ6Hr"
}
...
function getpwd_s() {
    var e = "b3d7de0a6ae618fa914e9cabfebc38157e87fabc2d38ff55e73418e6dea9d3dd==",
        t = md5() + getpwd_t()
        var n = new sjcl.misc.hmac(e);
    return sjcl.codec.base64.fromBits(n.encrypt(t))
}