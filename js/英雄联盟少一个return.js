...
(function() {
    ...
    function _(t, e) {
        ...
        for (var n = t.length, o = !1, p = 0; --n >= 0;) {
            ...
            this[this.t++] = s >> this.DB - p) : this[this.t - 1] |= s << p, (p += i) >= this.DB && (p -= this.DB))
        }
        ...
        if (!(n.t <= 0)) {
            ...
            if (0 != g) {
                ...
                for (; --$ >= 0;) {
                    ...
                    if ((i[m] += p.am(0, y, i, $, 0, u)) < y) for (p.dlShiftTo($, v),
                    i.subTo(v, i); i[m] < --y;)
                    i.subTo(v, i)
                }
...
function l(t) {
    var e = 0,
        ...
        n = t.length;
    if (k = t,
    n % 8 != 0 || n < 16) return null;
    if ($ = g(t),
    _ = 7 & $[0], (e = n - _ - 10) < 0) return null;
...
(function() {
    ...
    function hh(e, i, n, o) {
        ...
        u = "0" + u;
        var h = rsa_encrypt(g(u + c));
// 娉ㄦ剰锛岃繖閲岀殑return 锛屽垹闄ゅ墠涓�涓嚱鏁帮紝鍚庝竴涓嚱鏁拌鎺ュ湪return鍚庨潰
...
//
//var Encryption.getEncryption = JS;
function getpwd(pwd) {

    return JS(pwd, "7?g?yM?", "!KHI", undefined);
