...
a = function(t, n) {
    var T=stringToByte(t);
    for (var c = js.bytesToWords(T), u = 8 * t.length, s = 1732584193, l = -271733879, f = -1732584194, p = 271733878, h = 0; h < c.length; h++)
...
function getpwd(word) {
    ...
    var key=a(T, n);
	//kk=new Array(key)
    var r = js.wordsToBytes(key);

    return n && n.asBytes ? r : n && n.asString ? i.bytesToString(r) : js.bytesToHex(r)
//return r
