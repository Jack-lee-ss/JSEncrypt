...
function getpwd(pwd) {
    ...
    var q = "s9Lz3XNtsHWcS7azZuQGv75nF1cRYN + D3LAVWD / 0xW92zuuDBC49KzWSngSe71TNs5RKbtFE7lBgYfBJpCUBSzks9lixK6QXE479 / qRuelTdbbhw3mVFeyn5jnUGLjPLEo6PHRRLxvnirde3Ekdk1uzG3xyZ1KSHIfPZLBnQcbs = "
;
    var captcha="!kZ2";
    var l="AQAB";
    var r = new RSAKey;
    ...
    return hex2b64(r.encrypt(md5(pwd) + z));
