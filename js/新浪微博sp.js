navigator = {}; //Èç¹ûÐèÒªÓÃµ½ä¯ÀÀÆ÷Ð­ÒéÍ·£¬ÇëÔÚ<¼ÓÔØ´úÂë> °´Å¥ ÓÒ²àÑ¡Ôñ navigator.js
...
function getsu(pwd) {
    ...
    return sinaSSOEncoder.base64.encode(pwd)
}
...
function getpwd(pwd) {
    ...
    me = {
        retcode: 0,
        servertime: 1583028305,
        pcid: "gz-0e527d966e888cc525cd5b8491c95fa0fcd4",
        nonce: "LH3OU1",
    ...
    f.setPublic(me.pubkey, "10001");   ¡// ×¢Òâ pubkey ºÍ me.pubkey ÐèÒªÒ»ÖÂ
