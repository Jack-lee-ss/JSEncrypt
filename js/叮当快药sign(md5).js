...
function getpwd(pwd) {
    var user = "17823452345";
    var time=timer();
    return l("ddsy.user.reg.loginmethodddsy.user.reg.loginpassword" + l(pwd) + "platH5platformH5t"+time+"userName" + user + "v1.0versionName5.3.06C57AB91A1308E26B797F4CD382AC79D");
}