...
Md5.prototype.update = function(e) {
    if (!this.finalized) {
        ...
        for (var r, a, i = 0, o = e.length, s = this.blocks, c = this.buffer8; i < o;) {
            ...
            t) if (ARRAY_BUFFER) for (a = this.start; i < o && a < 64; ++i)
            c[a++] = e[i];
            else for (a = this.start; i < o && a < 64; ++i)
            s[a >> 2] |= e[i] << SHIFT[3 & a++];
            else if (ARRAY_BUFFER) for (a = this.start; i < o && a < 64; ++i)
            (r = e.charCodeAt(i)) < 128 ? c[a++] = r : r < 2048 ? (c[a++] = 192 | r >> 6,
            c[a++] = 128 | 63 & r) : r < 55296 || r >= 57344 ? (c[a++] = 224 | r >> 12,
            c[a++] = 128 | r >> 6 & 63,
            c[a++] = 128 | 63 & r) : (r = 65536 + ((1023 & r) << 10 | 1023 & e.charCodeAt(++i)),
            c[a++] = 240 | r >> 18,
            c[a++] = 128 | r >> 12 & 63,
            c[a++] = 128 | r >> 6 & 63,
            c[a++] = 128 | 63 & r);
