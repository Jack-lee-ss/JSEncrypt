...
function bnToString(t) {
    ...
    if (s-- > 0) for (h < this.DB && (r = this[s] >> h) > 0 && (n = !0,
    e = int2char(r)); s >= 0;)
...
function bnpSubTo(t, i) {
    ...
    i.s = 0 > o ? -1 : 0, -1 > o ? i[r++] = this.DV + o : o > 0 && (i[r++] = o),
    i.t = r,
    i.clamp()
}
    ...
    if (!(o.t <= 0)) {
        ...
        if (0 != f) {
            ...
            for (; --b >= 0;) {
                ...
                if ((r[v] += e.am(0, T, r, b, 0, a)) < T) for (e.dlShiftTo(b, l),
                r.subTo(l, r); r[v] < --T;)
                r.subTo(l, r)
            }
...
function hex2b64(r) {
    ...
    n += b64map.charAt(a >> 2) + b64map.charAt((3 & a) << 4));
    (3 & n.length) > 0;)
    n += b64padchar;
    return n
}
