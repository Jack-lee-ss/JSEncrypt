...
function getpwd(pwd){
	    //var n = e("wGdk");
            var r = c.Utf8.parse("youzan.com.aesiv");
            o = c.Utf8.parse("youzan.com._key_");
        return {
            encrypt: function(pwd) {
                return t = c.Utf8.parse(pwd),
                n.AES.encrypt(t, o, {
                    mode: n.mode.CBC,
            ...
            decrypt: function(t) {
                var e = n.AES.decrypt(t, o, {
                    mode: n.mode.CBC,
                    padding: n.pad.Iso10126,
                    iv: r
                });
                return n.enc.Utf8.stringify(e)
            }
        }
